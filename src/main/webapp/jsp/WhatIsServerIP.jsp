...
<HTML>
<HEAD><TITLE>What Is My Server IP </TITLE></HEAD>
<BODY BGCOLOR="white">
<H1>What Is My Server IP </H1>
...
<FORM ACTION="WhatIsServerIP.jsp" METHOD="POST" NAME="Form1">
...
<FORM ACTION="jsp/ClearSession.jsp" method="POST" name="Form2" >
